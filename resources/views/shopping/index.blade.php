    ...
    @section('main')
        ...
        <div id="section1" class="mb-2">
            <div class="swiper mySwiper container-fluid ">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><img src=" {{asset('img/homepage-img/imgA.jpg')}}" alt=""></div>
                    <div class="swiper-slide"><img src=" {{asset('img/homepage-img/imgB.jpg')}}" alt=""></div>
        ...
        <div id="section3" class="goods-photo container-fluid d-flex">
            ...
            <div class="goods-photo-bottom d-flex justify-content-center">
                ...
                <div class="goods-photo-left d-flex row">
                    <div class="l-box1"><img src="{{asset('img/homepage-img/imgC.jpg')}}" alt=""></div>
                    <div class="l-box2"><img src="{{asset('img/homepage-img/imgD.jpg')}}" alt=""></div>
                    <div class="l-box3"><img src="{{asset('img/homepage-img/imgE.jpg')}}" alt=""></div>
                </div>
                <!-- 展示照右方區塊 -->
                <div class="goods-photo-right d-flex">
                    <div class="r-box3"><img src="{{asset('img/homepage-img/imgA.jpg')}}" alt=""></div>
                    <div class="r-box1"><img src="{{asset('img/homepage-img/imgB.jpg')}}" alt=""></div>
                    <div class="r-box2"><img src="{{asset('img/homepage-img/imgC.jpg')}}" alt=""></div>
        ...
        <div id="section5" class="goods-photo2 container-fluid p-0">
            ...
            <div class="goods-photo2-bottom">
                <div class="card">
                    <img src="{{asset('img/homepage-img/imgA.jpg')}}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h6>SUBTITLE</h6>
                        <h5>Chichen Itza</h5>
                ...
                <div class="card">
                    <img src="{{asset('img/homepage-img/imgB.jpg')}}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h6>SUBTITLE</h6>
                ...
                <div class="card">
                    <img src="{{asset('img/homepage-img/imgC.jpg')}}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h6>SUBTITLE</h6>
                ...
                <div class="card">
                    <img src="{{asset('img/homepage-img/imgD.jpg')}}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h6>SUBTITLE</h6>
                        <h5>San Francisco</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk
            ...
            <div class="unknown-content ">
                ...
                <div class="card mb-3 ">
                    <div class="card-container row g-0 d-flex align-items-center">
                        <div class="card-img col-md-4">
                            <img src="{{asset('img/homepage-img/imgA.jpg')}}" class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                ...
                <div class="card mb-3 ">
                    <div class="card-container row g-0 d-flex align-items-center flex-row-reverse">
                        <div class="card-img col-md-4">
                            <img src="{{asset('img/homepage-img/imgB.jpg')}}" class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
                ...
                <div class="card card-3 mb-3">
                    <div class="card-container row g-0 d-flex justify-content-center align-items-center">
                        <div class="card-img col-md-4">
                            <img src="{{asset('img/homepage-img/imgC.jpg')}}" class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
        ...
        <div id="section7" class="big-goods-photo flex-column container-xxl flex-md-row">
            ...
            <div class="bgph-left col-12 col-md-6 h-auto">
                <img src="{{asset('img/homepage-img/imgA.jpg')}}" alt="" class="h-100">
            </div>
            <!-- 右方文字說明及下定按鈕 -->
        ...
        <div id="section8" class="little-goods-photo d-flex">
            ...
            <div class="box2 d-flex">
                ...
                <div class="card">
                    <img src="{{asset('img/homepage-img/imgE.jpg')}}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h3>CATEGORY</h3>
                        <h2>Neptune</h2>
                        <p class="card-text">$21.00</p>
